...
export const blogPosts: BlogPost[] = [
  { id: 'agentes-llm-produccion', titleKey: 'blog.posts.0.title', descriptionKey: 'blog.posts.0.description', categoryKey: 'blog.categories.ai', publishedAt: '2026-07-24', featured: true },
